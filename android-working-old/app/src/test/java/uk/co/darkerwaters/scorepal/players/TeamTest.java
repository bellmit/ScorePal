...
public class TeamTest {
    ...
    public void onePlayer() {
        ...
        Team teamOne = new Team(0, new Player[]{playerOne}, CourtPosition.NORTH);
    ...
    public void courtPosition() {
        Team teamOne = new Team(0, new Player[]{new Player(0, "playerOne")}, CourtPosition.NORTH);
        assertEquals("court position", CourtPosition.NORTH, teamOne.getCourtPosition());
    ...
    public void resetTeam() {
        Player playerOne = new Player(0, "playerOne");
        Player playerTwo = new Player(1, "playerOne");
        Team teamOne = new Team(0, new Player[]{playerOne, playerTwo}, CourtPosition.NORTH);
        // test default
    ...
    public void playerInTeam() {
        ...
        assertEquals("player not in team", false, teamOne.isPlayerInTeam(new Player(0, "unknown")));
    }
}