...
import uk.co.darkerwaters.scorepal.score.ScoreTest;
...
public class TennisScoreTest extends ScoreTest {
    ...
    public void settingTennisValues() {
        ...
        TennisScore score = new TennisScore(this.teams, TennisSets.FIVE, new TennisMatchSettings(null));
    ...
    public void scoreBasicString() {
        Score score = new TennisScore(this.teams, TennisSets.ONE, new TennisMatchSettings(null));
        for (int i = 0; i < 4; ++i) {
            score.setPoint(0, this.teams[0], i);
            assertEquals("team one pt string", TennisPoint.values()[i], score.getDisplayPoint(0, this.teams[0]));
        }
        // check the invalid number
        score.setPoint(0, this.teams[0], 6);
        score.setPoint(0, this.teams[1], 7);
        assertEquals("team one pt string", TennisPoint.FORTY, score.getDisplayPoint(0, this.teams[0]));
        assertEquals("team two pt string", TennisPoint.ADVANTAGE, score.getDisplayPoint(0, this.teams[1]));
    }
    ...
    public void scoreString() {
        ...
        score.setPoint(0, this.teams[0], 0);
        assertEquals("team one pt string", TennisPoint.LOVE, score.getDisplayPoint(0, this.teams[0]));
        assertEquals("team two pt string", TennisPoint.LOVE, score.getDisplayPoint(0, this.teams[0]));

        // 15 love
        score.setPoint(0, this.teams[0], 1);
        assertEquals("team one pt string", TennisPoint.FIFTEEN, score.getDisplayPoint(0, this.teams[0]));

        // 30 love
        score.setPoint(0, this.teams[0], 2);
        assertEquals("team one pt string", TennisPoint.THIRTY, score.getDisplayPoint(0, this.teams[0]));
        ...
        assertEquals("team one pt string", TennisPoint.GAME, score.getDisplayPoint(0, this.teams[0]));

        // Deuce
        score.setPoint(0, this.teams[0], 3);
        score.setPoint(0, this.teams[1], 3);
        assertEquals("team one pt string", TennisPoint.DEUCE, score.getDisplayPoint(0, this.teams[0]));

        // ad 40
        score.setPoint(0, this.teams[0], 4);
        assertEquals("team one pt string", TennisPoint.ADVANTAGE, score.getDisplayPoint(0, this.teams[0]));
        ...
        assertEquals("team two pt string", TennisPoint.GAME, score.getDisplayPoint(0, this.teams[1]));
    }
    ...
    public void tieBreakScore() {
        ...
        TennisScore score = new TennisScore(teams, TennisSets.THREE, new TennisMatchSettings(null));
    ...
    public void pointsTotals() {
        TennisScore score = new TennisScore(this.teams, TennisSets.ONE, new TennisMatchSettings(null));
    ...
    public void tieBreakServing() {
        ...
        Player firstServer = teams[0].getPlayers()[0];
        Player secondServer = teams[1].getPlayers()[0];
        score.changeServer(firstServer);
    ...
    public void tieBreakServingDoubles() {
        // player who's turn to serve starts the tie
        TennisMatchSettings settings = new TennisMatchSettings(null);
        settings.setIsDoubles(true);
        TennisScore score = new TennisScore(doubles, TennisSets.THREE, settings);
    ...
    public void tieBreakFinalSet() {
        ...
        TennisScore score = new TennisScore(doubles, TennisSets.THREE, new TennisMatchSettings(null));
    ...
    public void tieBreakInFinalSet() {
        ...
        TennisMatchSettings settings = new TennisMatchSettings(null);
        settings.setFinalSetTieTarget(6);
        TennisScore score = new TennisScore(doubles, TennisSets.THREE, settings);
    ...
    public void setsToWin() {
        // best of 1, 3 or 5
        TennisMatchSettings settings = new TennisMatchSettings(null);
        TennisScore score = new TennisScore(doubles, TennisSets.ONE, settings);
        // win this set
        ...
        // win a three setter
        score = new TennisScore(doubles, TennisSets.THREE, settings);
        ...
        // win a five setter
        score = new TennisScore(doubles, TennisSets.FIVE, settings);
    ...
    public void changingEnds() {
        ...
        TennisMatchSettings settings = new TennisMatchSettings(null);
        TennisScore score = new TennisScore(teams, TennisSets.THREE, settings);
