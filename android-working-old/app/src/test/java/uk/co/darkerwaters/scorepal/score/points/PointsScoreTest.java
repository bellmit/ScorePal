...
public class PointsScoreTest extends ScoreTest {
    ...
    public void playShortPointsGame() {
        // create a short game
        PointsMatchSettings settings = new PointsMatchSettings(null);
        settings.setScoreGoal(10);
        settings.setIsTwoPointsAheadRequired(false);
        PointsScore score = new PointsScore(this.teams, settings);
    ...
    public void serving() {
        ...
        PointsMatchSettings settings = new PointsMatchSettings(null);
        settings.setScoreGoal(7);
        PointsScore score = new PointsScore(this.teams, settings);
        // player one should serve
        Player firstServer = this.teams[0].getPlayer(0);
        Player secondServer = this.teams[1].getPlayer(0);
    ...
    public void servingDoubles() {
        ...
        PointsScore score = new PointsScore(this.doubles, settings);
        // player one should serve
