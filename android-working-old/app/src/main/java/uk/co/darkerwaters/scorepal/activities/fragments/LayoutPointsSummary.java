...
public class LayoutPointsSummary extends LayoutScoreSummary<PointsMatch> {
    ...
    public View createView(LayoutInflater inflater, ViewGroup container) {
        ...
        View mainView = inflater.inflate(R.layout.layout_points_summary, container, false);
    ...
    @Override
    public void showCurrentServer(PointsMatch match) {
    ...
    @Override
    public void setMatchData(final PointsMatch match, final MatchRecyclerAdapter.MatchFileListener source) {
