...
import uk.co.darkerwaters.scorepal.activities.fragments.CardHolderStatistics;
...
public class StatisticsRecyclerAdapter extends RecyclerView.Adapter<CardHolderStatistics> {
    ...
    public void updateStatistics() {
        ...
        MatchStatistics matchStatistics = MatchStatistics.GetInstance(this.application, this.context);
        ...
        for (Sport sport : Sport.values()) {
            if (matchStatistics.getTotalLosses(sport) > 0 ||
                ...
                this.dataList.add(new CardHolderStatistics.StatisticsCard(this.application, context, sport));
            }
        }
        // and our opponents
        for (String opponent : matchStatistics.getOpponents()) {
            this.dataList.add(new CardHolderStatistics.StatisticsCard(this.application, context, opponent, this.contactResolver));
        }
