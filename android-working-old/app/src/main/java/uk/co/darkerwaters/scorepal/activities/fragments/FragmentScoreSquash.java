...
public class FragmentScoreSquash extends FragmentScore {

    private final static int K_NO_LEVELS = 2;

    public FragmentScoreSquash() {
        super(K_NO_LEVELS);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View mainView = inflater.inflate(R.layout.fragment_score_squash, container, false);
        // init the activity
