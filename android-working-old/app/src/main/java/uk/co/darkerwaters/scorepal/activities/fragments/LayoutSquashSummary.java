...
public class LayoutSquashSummary extends LayoutScoreSummary<SquashMatch> {
    ...
    public View createView(LayoutInflater inflater, ViewGroup container) {
        ...
        View mainView = inflater.inflate(R.layout.layout_squash_summary, container, false);
    ...
    @Override
    public void showCurrentServer(SquashMatch match) {
    ...
    @Override
    public void setMatchData(final SquashMatch match, final MatchRecyclerAdapter.MatchFileListener source) {
