...
public class FragmentPreviousSets extends Fragment {
    ...
    private final TextSwitcher[][] switchers = new TextSwitcher[K_NO_TEAMS][K_NO_SETS];
    private ViewSwitcher.ViewFactory[] switcherFactories;
    private final TextView[] tieBreaks = new TextView[K_NO_SETS];
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        this.switcherFactories = new ViewSwitcher.ViewFactory[2];
    ...
    public void setTieBreakResult(int setIndex, int score1, int score2) {
        if (!this.isDetached()) {
            this.tieBreaks[setIndex].setText(getString(R.string.tie_display, score1, score2));
