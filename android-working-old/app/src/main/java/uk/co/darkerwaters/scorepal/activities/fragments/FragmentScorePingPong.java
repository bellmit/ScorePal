...
public class FragmentScorePingPong extends FragmentScore {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View mainView = inflater.inflate(R.layout.fragment_score_ping_pong, container, false);
        // init the activity
    ...
    protected void createViewSwitchers(TextSwitcher[][] switchers, View mainView) {
        ...
        switchers[0][0] = mainView.findViewById(R.id.rounds_teamOne);
        switchers[0][1] = mainView.findViewById(R.id.points_teamOne);
        // and team two
        switchers[1][0] = mainView.findViewById(R.id.rounds_teamTwo);
