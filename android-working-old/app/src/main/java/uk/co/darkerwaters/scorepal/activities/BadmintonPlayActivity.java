...
import uk.co.darkerwaters.scorepal.activities.fragments.FragmentScoreBadminton;
...
public class BadmintonPlayActivity extends PlayMatchActivity {

    private FragmentScoreBadminton scoreFragment;
    private FragmentTime timeFragment;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_badminton_play);

        // initialise our activity
        setupActivity(Sport.BADMINTON, (ViewGroup)findViewById(R.id.main_layout));
    }
    ...
    protected Fragment[] createMatchFragments() {
        ...
        if (null == this.scoreFragment) {
            this.scoreFragment = new FragmentScoreBadminton();
        }
    ...
    protected boolean setupActivity(Sport sport, ViewGroup mainLayout) {
        ...
        if (false == currentMatch instanceof BadmintonMatch) {
            // the current match is not a badminton match, so we are responsible for starting
    ...
    public void onAttachFragment(FragmentScore fragment) {
        ...
        this.scoreFragment = (FragmentScoreBadminton) fragment;
    }
    ...
    protected void showActiveScore() {
        ...
        if (null != this.scoreFragment) {
            ...
            // get the score
            BadmintonScore score = (BadmintonScore) currentMatch.getScore();
            // set the score
