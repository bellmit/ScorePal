...
public class FragmentTime extends Fragment {
    ...
    private TextView momentumFocusTextView;
    private MatchMomentumGraph matchMomentumGraph;

    private final TextSwitcher[][] switchers = new TextSwitcher[K_NO_TIMES][K_NO_DIGITS];
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // find the momentum view
        this.momentumFocusTextView = mainView.findViewById(R.id.momentumFocusTextView);
        this.matchMomentumGraph = mainView.findViewById(R.id.matchMomentumGraph);
        this.momentumFocusTextView.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void onResume() {
        ...
        if (null != communicator) {
            setMatchHistory(communicator.getCurrentMatch());
        }
        ...
        // and register to receive time update
    ...
    public void setMatchHistory(Match match) {
        ...
        if (null != this.matchMomentumGraph && null != match && null != context) {
            // set the focus correctly
            this.matchMomentumGraph.setGraphFocus(this.momentumFocus);
            // and show this on the button
            this.momentumFocusTextView.setText(
            ...
            this.momentumFocusTextView.setTextColor(context.getColor(this.momentumFocus == 0 ?
    ...
    private void onTimeChanged() {
        if (!this.isDetached() && null != this.switchers) {
